...
const About = ({ title, subtitle, content, urlLabel }) => {
  return (
...
About.defaultProps = {
  urlLabel: 'Check out some of my latest projects.',
  title: "About",
  subTitle: "Who I Am",
  content: ` I finished my IT bachelor in 2018. Next I started developing websites on CMS platforms sush as Wordpress/woocommerce, Drupal, Lightspeed and Shopify.
            <br />
            <br />
